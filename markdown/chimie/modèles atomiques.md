# Modèles atomiques
Un modèle atomiques est une représentation simplifiée des molécules qui composent les [atomes](atome). Avec le temps, ces modèles ont évolué en fonction de l'avancée scientifique.
...
## Modèle de Bohr (1913)
Les électrons gravitent autour du noyau sur des orbites précises, ce sont les [couches électroniques](couches%20électroniques) :
